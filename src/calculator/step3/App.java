...
public class App {
    public static void main(String[] args) {
        ...
        AritnmeticCalculator cal = new AritnmeticCalculator();
        ...
        while (run) {
            ...
            System.out.println("결과: " + cal.calculate(OperatorType.convert(op), num1, num2));
        ...
        if (confirmView.equals("y")) {
            System.out.println("저장된 결과: " + AritnmeticCalculator.getResult());
        } else {
        ...
        if (confirmRemove.equals("y")) {
            AritnmeticCalculator.removeFirstResult();
            System.out.println("제거가 완료되었습니다.");
            System.out.println("남은 데이터는: " + AritnmeticCalculator.getResult() + "입니다.");
        }
    }
}
